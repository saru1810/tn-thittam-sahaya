    ...
    if (input.includes('scheme') || input.includes('திட்ட')) {
      ...
      if (input.includes('document') || input.includes('ஆவண')) {
        return language === 'en'
          ...
          : "தேவையான பொதுவான ஆவணங்கள்: ஆதார் அட்டை, வருமான சான்றிதழ், சாதி சான்றிதழ், கல்வி சான்றிதழ்கள், வங்கி பாஸ்புக் மற்றும் சமீபத்திய புகைப்படங்கள். திட்டத்தின் அடிப்படையில் குறிப்பிட்ட தேவைகள் மாறுபடும்.";
      }
      return language === 'en'
